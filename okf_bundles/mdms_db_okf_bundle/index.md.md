...
| :------------------------------------------ | :----------------------------------------------------------------------------------------------------------------------------- | :----------------------------------------------------------------------- | :------------------------------------------------------------------------ |
| [mdms_master_db](./mdms_master_db/index.md) | Stores master data of Consumers, Smart Meter, DTR, Feeder, Organization Master i.e Division, Section, Subdivision, Circle etc. | consumer, customer, account, smart meter, hardware, disconnected, status | *(Add any related DBs here, e.g., `[/billing_db](/billing_db/index.md)`)* |